...
<head>
  ...
  <title>Buku Antikorupsi | Ubah Password</title>
  <!-- favicon  -->
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item active" href="ubah_password">
        ...
        <div class="container-fluid">
          ...
          <div class="card p-4 shadow">
            <form class="formUpload" method="post">

              <div class="form-group">
                <label for="username">Username Lama</label>
                <input type="text" class="form-control" id="username" required name="old_username">
              </div>
              <div class="form-group">
                <label for="oldf_pass">Password Lama</label>
                <input type="password" class="form-control" id="oldf_pass" required name="old_pass">
              </div>
              <div class="form-group">
                <label for="username">Username Baru</label>
                <input type="text" class="form-control" id="username" required name="new_username">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <div class="custom-control custom-checkbox small">
                  ...
                  <label class="custom-control-label" for="customCheck">Saya setuju untuk mengganti password dan username lama</label>
                </div>
              </div>
              <div class="input-group">
    						<button type="submit" name="ubah" class="btn btn-danger w-100">Ubah Password</button>
    					</div>
            </form>
          </div>
          <!-- End Form Upload -->
